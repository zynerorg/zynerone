$(document).ready(function () {
      ...
      $(this)
        ...
        .each(function () {
          ...
          if ($(this).val() && $(this).attr("regex")) {
            ...
            if (
              !regex_content.startsWith("/") ||
              !/\/[ims]?$/.test(regex_content)
            ) {
              invalid = true;
              $(this).addClass("inputMissingAttr");
            }
  ...
  $("button[data-datatables-expand], a[data-datatables-expand]").on(
    "click",
    function (e) {
      e.preventDefault();
  ...
  $("button[data-datatables-collapse], a[data-datatables-collapse]").on(
    "click",
    function (e) {
      e.preventDefault();
