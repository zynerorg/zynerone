...
<clientConfig version="1.1">
   <emailProvider id="<?= $zynerone_hostname; ?>">
      <domain>%EMAILDOMAIN%</domain>
      <displayName>Zyner One</displayName>
      <displayShortName>Zyner One</displayShortName>
      ...
      <enable visiturl="https://<?= $zynerone_hostname; ?><?php if ($port != 443)
          echo ':' . $port; ?>/admin.php">
         <instruction>If you didn't change the password given to you by the administrator or if you didn't change it in
            a long time, please consider doing that now.</instruction>
         <instruction lang="de">Sollten Sie das Ihnen durch den Administrator vergebene Passwort noch nicht geändert
            haben, empfehlen wir dies nun zu tun. Auch ein altes Passwort sollte aus Sicherheitsgründen geändert werden.
         </instruction>
      </enable>
   ...
   <webMail>
      <loginPage url="https://<?= $zynerone_hostname; ?><?php if ($port != 443)
          echo ':' . $port; ?>/SOGo/" />
   </webMail>
</clientConfig>