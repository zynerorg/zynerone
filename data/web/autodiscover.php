...
if (strpos($data, 'autodiscover/outlook/responseschema') !== false) {
  ...
  if (
    $autodiscover_config['useEASforOutlook'] == 'yes' &&
...
if ($login_role === "user") {
  ...
  <Autodiscover xmlns="http://schemas.microsoft.com/exchange/autodiscover/responseschema/2006">
    ...
    <Response xmlns="http://schemas.microsoft.com/exchange/autodiscover/outlook/responseschema/2006a">
      <User>
        <DisplayName>
          <?= htmlspecialchars($displayname, ENT_XML1 | ENT_QUOTES, 'UTF-8'); ?>
        </DisplayName>
      </User>
      <Account>
        ...
        if (getenv('SKIP_SOGO') != "y") {
          ...
          <Protocol>
            ...
            <Server>https://
              ...
              <?php if ($autodiscover_config['caldav']['port'] != 443)
                echo ':' . $autodiscover_config['caldav']['port']; ?>/SOGo/dav/
              <?= $email; ?>/
            </Server>
            <DomainRequired>off</DomainRequired>
            <LoginName>
          ...
          <Protocol>
            <Type>CardDAV</Type>
            <Server>https://
              <?= $autodiscover_config['carddav']['server']; ?>
              <?php if ($autodiscover_config['caldav']['port'] != 443)
                echo ':' . $autodiscover_config['carddav']['port']; ?>/SOGo/dav/
              <?= $email; ?>/
            </Server>
            <DomainRequired>off</DomainRequired>
            <LoginName>
